...
const accordionTriggerStyle = tva({
  base: "w-full flex-row items-center justify-between focus:outline-none web:outline-none data-[focus-visible=true]:bg-background-50 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-40",
});
